    ...
    function se(e, r, i, a, o) {
      ...
      if (ee(e))
        for (var u = 0; u < e.length; u++)
          ((a = e[u]), (s = l + T(a, u)), (c += se(a, r, i, s, o)));
      else if (((u = m(e)), typeof u == `function`))
        for (e = u.call(e), u = 0; !(a = e.next()).done;)
          ((a = a.value), (s = l + T(a, u++)), (c += se(a, r, i, s, o)));
      else if (s === `object`) {
  ...
  h = o((e) => {
    ...
    function be(e) {
      (me.current === e && (k(pe), k(me)),
        ge.current === e && (k(ge), (Qf._currentValue = ue)));
    }
    var xe, Se;
    function Ce(e) {
      if (xe === void 0)
...
` +
    ...
    function Do(e, t, n, r, i, a) {
      return (
        ...
        (t.updateQueue = null),
        (t.lanes = 0),
        (E.H = e === null || e.memoizedState === null ? Us : Ws),
        (xo = !1),
        (a = n(r, i)),
        (xo = !1),
        bo && (a = ko(t, n, r, i)),
    ...
    function Oo(e) {
      ...
      e === null ||
        B ||
        ((e = e.dependencies), e !== null && oa(e) && (B = !0));
    }
    function ko(e, t, n, r) {
      F = e;
      var a = 0;
    ...
    function Io(e) {
      ...
      return (
        ...
        (L === null ? t.memoizedState : L.next) === null &&
          ((t = t.alternate),
          (E.H = t === null || t.memoizedState === null ? Us : Ws)),
        e
      );
    }
    function Lo(e) {
    ...
    function Vo(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Ar(o, e.memoizedState) && ((B = !0), d && ((n = ya), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
    ...
    function Fs(e, t, n) {
      ...
      ((n = {
        ...
        zs(e)
          ? Bs(t, n)
          : ((n = ui(e, t, n, r)), n !== null && (hu(n, e, r), Vs(n, t, r))));
    }
    function Is(e, t, n) {
      Ls(e, t, n, pu());
    }
    ...
    function ac(e, t, n, r, a) {
      ...
      if (M)
        return (
          (t = lo.current),
          t === null
            ? (r !== Wi && ((t = Error(i(423), { cause: r })), Zi(Ei(t, n))),
            ...
            : (!(t.flags & 65536) && (t.flags |= 256),
              (t.flags |= 65536),
              (t.lanes = a),
              r !== Wi && ((e = Error(i(422), { cause: r })), Zi(Ei(e, n)))),
          !1
        );
      ...
      if (o !== null) {
        ...
        if ((po(t), a)) {
          ...
          if (
            ...
            throw ((o.retryLane = s), di(e, s), hu(r, e, s), oc);
          (Du(), (t = hc(e, t, n)));
        } else
          ((e = o.treeContext),
            (j = cf(s.nextSibling)),
    ...
    function Tc(e, t, n) {
      ...
      if (
        ((s = o) ||
          (s = e !== null && e.memoizedState === null ? !1 : !!(P.current & 2)),
        s && ((a = !0), (t.flags &= -129)),
        (s = !!(t.flags & 32)),
        (t.flags &= -33),
        e === null)
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (
            ...
            throw ((l.retryLane = r), di(e, r), hu(s, e, r), oc);
          (af(c) || Du(), (t = Oc(e, t, n)));
        } else
          af(c)
    ...
    function zc(e, t) {
      (t !== null && (e.flags |= 4),
        e.flags & 16384 &&
          ((t = e.tag === 22 ? 536870912 : nt()), (e.lanes |= t), (Xl |= t)));
    }
    function Bc(e, t) {
      if (!M)
        switch (e.tailMode) {
      ...
      switch (n.tag) {
        ...
        case 22:
          if (((r = n.memoizedState !== null || rl), !r)) {
            ...
            var a = H;
            ((rl = r),
              (H = t) && !a ? wl(e, n, !!(n.subtreeFlags & 8772)) : Sl(e, n),
              (rl = i),
              (H = a));
          }
          break;
            ...
            : (J =
                t === oc
                  ...
                  : typeof t == `object` && t && typeof t.then == `function`
                    ...
                    : 1),
        (Vl = t),
        K === null && ((Y = 1), ec(e, Ei(t, e.current))));
    }
    function wu() {
      var e = lo.current;
      return e === null
    ...
    function Nu(e) {
      ...
      switch (t.tag) {
        ...
        case 5:
          No(t);
        default:
          (Uc(n, t), (t = K = yi(t, Gl)), (t = Fc(n, t, Gl)));
      }
      ((e.memoizedProps = e.pendingProps), t === null ? Fu(e) : (K = t));
    }
    function Pu(e, t, n, r) {
    ...
    function Ku(e, t, n) {
      ...
      (r !== null && r.delete(t),
        ...
        G === e &&
          (q & n) === n &&
          (Y === 4 || (Y === 3 && (q & 62914560) === q && 300 > Ne() - eu)
            ? !(W & 2) && Su(e, 0)
            : (Jl |= n),
          Xl === q && (Xl = 0)),
        rd(e));
...
`,
      ...
      questions: [
        {
          ...
          options: [
            ...
            `Dissatisfied`,
            `Very Dissatisfied`,
          ].map((e, t) => ({ id: `option-${t + 1}`, text: e })),
          additionalComments: !1,
          logic: { enabled: !1, conditions: [] },
          buttonText: `Next`,
        },
      ],
      thankYou: {
  ...
  b = (e) => `${e}-${Date.now()}-${Math.random().toString(36).slice(2, 7)}`,
  x = (e) => ({
    id: b(`question`),
    title: `Question ${e}`,
    subtitle: `Please select one option.`,
    options: [
      { id: b(`option`), text: `Option 1` },
      { id: b(`option`), text: `Option 2` },
    ],
    additionalComments: !1,
    logic: { enabled: !1, conditions: [] },
    buttonText: `Next`,
  ...
  ee = (e, t, n) => {
    let r = t.split(`.`),
      i = structuredClone(e),
      a = i;
    return (r.slice(0, -1).forEach((e) => (a = a[e])), (a[r.at(-1)] = n), i);
  };
function te(e, t) {
  switch (t.type) {
    case `UPDATE_SURVEY_PAGE_COUNT`: {
      let n = Math.max(1, +t.value || 1),
        r = [...e.content.questions];
      for (; r.length < n;) r.push(x(r.length + 1));
      return (
        (r = r.slice(0, n)),
        {
          ...e,
          content: { ...e.content, numberOfPages: n, questions: r },
          preview: {
            ...e.preview,
            currentQuestion: Math.min(e.preview.currentQuestion, n - 1),
          },
        }
      );
    }
    case `UPDATE_QUESTION`:
      return {
        ...
        content: {
          ...e.content,
          questions: e.content.questions.map((e) =>
          ...
          questions: e.content.questions.map((e) =>
            e.id === t.questionId
              ? {
                  ...
                  options: [
                    ...e.options,
                    { id: b(`option`), text: `Option ${e.options.length + 1}` },
                  ],
                }
              : e,
          ),
    ...
    case `DELETE_OPTION`:
      return {
        ...
        content: {
          ...e.content,
          questions: e.content.questions.map((e) =>
            e.id === t.questionId && e.options.length > 2
              ? { ...e, options: e.options.filter((e) => e.id !== t.optionId) }
              : e,
          ),
        },
      };
            ...
            e.id === t.questionId
              ? {
                  ...
                  options: e.options.map((e) =>
                    e.id === t.optionId ? { ...e, text: t.text } : e,
                  ),
                }
              : e,
          ),
    ...
    case `ADD_CONDITION`:
      return {
        ...
        content: {
          ...e.content,
          questions: e.content.questions.map((n) =>
            n.id === t.id
              ? {
                  ...n,
                  logic: {
                    ...
                    conditions: [
                      ...
                      {
                        id: b(`condition`),
                        optionId: n.options[0]?.id || ``,
                        target: Math.min(e.content.questions.length, 2),
                      },
                    ],
                  },
                }
          ...
          questions: e.content.questions.map((e) =>
            e.id === t.questionId
              ? {
                  ...
                  logic: {
                    ...e.logic,
                    conditions: e.logic.conditions.map((e) =>
                      e.id === t.id ? { ...e, ...t.patch } : e,
                    ),
                  },
                }
    ...
    case `UPDATE_THANK_YOU`:
      return {
        ...
        content: {
          ...e.content,
          thankYou: { ...e.content.thankYou, ...t.patch },
        },
      };
    case `UPDATE_STYLE`:
      return { ...e, styling: ee(e.styling, t.path, t.value) };
    case `SET_CURRENT_QUESTION`:
      return {
        ...e,
        preview: { ...e.preview, currentQuestion: t.index, showThankYou: !1 },
      };
    case `SELECT_OPTION`:
      return {
        ...e,
        preview: {
          ...e.preview,
          selectedOptions: {
            ...e.preview.selectedOptions,
            [t.questionId]: t.optionId,
          },
        },
      };
    case `UPDATE_COMMENT`:
      return {
        ...
        preview: {
          ...e.preview,
          comments: { ...e.preview.comments, [t.questionId]: t.value },
        },
      };
    case `SHOW_THANK_YOU`:
      return { ...e, preview: { ...e.preview, showThankYou: !0 } };
    case `CLOSE_SURVEY`:
      return { ...e, preview: { ...e.preview, isClosed: !0 } };
    case `RESET_SURVEY`:
...
var S = o((e) => {
  ...
  ne = (0, _.createContext)(null);
function re({ children: e }) {
  let [t, n] = (0, _.useReducer)(te, y);
  return (0, C.jsx)(ne.Provider, {
...
function ie() {
  return (0, C.jsxs)(`header`, {
    children: [
      (0, C.jsxs)(`div`, {
        children: [
          (0, C.jsx)(`span`, { className: `logo`, children: `S` }),
          (0, C.jsxs)(`div`, {
            children: [
              (0, C.jsx)(`strong`, { children: `Survey Campaign Builder` }),
              (0, C.jsx)(`small`, {
                children: `Build interactive campaigns in real time`,
              }),
            ],
          }),
        ],
...
function ae({ title: e, children: t, open: n = !1 }) {
  let [r, i] = (0, _.useState)(n);
  return (0, C.jsxs)(`section`, {
    ...
    children: [
      (0, C.jsxs)(`button`, {
        ...
        onClick: () => i(!r),
        children: [e, (0, C.jsx)(`span`, { children: r ? `−` : `+` })],
      }),
      r && (0, C.jsx)(`div`, { className: `accordion-body`, children: t }),
    ],
  });
}
function w({ label: e, value: t, onChange: n, min: r, max: i, step: a = 1 }) {
  return (0, C.jsxs)(`label`, {
    className: `field`,
    children: [
      e && (0, C.jsx)(`span`, { children: e }),
      (0, C.jsx)(`input`, {
        type: `number`,
        value: t ?? 0,
        min: r,
...
var T = () => {
  let e = (0, _.useContext)(ne);
  if (!e) throw Error(`useSurvey must be used inside SurveyProvider`);
  return e;
};
function oe() {
  let { state: e, dispatch: t } = T();
  return (0, C.jsxs)(ae, {
    ...
    children: [
      (0, C.jsx)(w, {
        ...
        value: e.content.numberOfPages,
        min: 1,
        onChange: (e) => t({ type: `UPDATE_SURVEY_PAGE_COUNT`, value: e }),
      }),
      (0, C.jsx)(`p`, {
        className: `hint`,
        children: `Each page represents one survey question.`,
      }),
    ],
  });
}
function se({ label: e, value: t, onChange: n, ...r }) {
  return (0, C.jsxs)(`label`, {
    className: `field`,
    children: [
      e && (0, C.jsx)(`span`, { children: e }),
...
function le({ question: e }) {
  ...
  return (0, C.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, C.jsx)(`button`, {
        className: `secondary`,
        onClick: () => t({ type: `ADD_OPTION`, questionId: e.id }),
        children: `+ Add Option`,
      }),
    ],
  });
}
function E({ label: e, value: t, onChange: n, options: r = [] }) {
  return (0, C.jsxs)(`label`, {
    className: `field`,
    children: [
      e && (0, C.jsx)(`span`, { children: e }),
...
function D({ question: e }) {
  let { state: t, dispatch: n } = T(),
    r = (t) => n({ type: `UPDATE_QUESTION`, id: e.id, patch: t });
  return (0, C.jsxs)(`div`, {
    className: `logic`,
    children: [
      (0, C.jsx)(ce, {
        label: `Enable Conditional Logic`,
        checked: e.logic.enabled,
        onChange: (t) => r({ logic: { ...e.logic, enabled: t } }),
      }),
      e.logic.enabled &&
        (0, C.jsxs)(C.Fragment, {
          children: [
            (0, C.jsx)(`p`, {
              className: `hint`,
              children: `Mock branching UI; conditions are stored in state.`,
            }),
            e.logic.conditions.map((r) =>
              (0, C.jsxs)(
                `div`,
                {
                  className: `grid2`,
                  children: [
                    ...
                    (0, C.jsx)(E, {
                      ...
                      options: t.content.questions.map((e, t) => ({
                        value: String(t + 1),
                        label: `Question ${t + 1}`,
                      })),
                    }),
            ...
            (0, C.jsx)(`button`, {
              className: `secondary`,
              onClick: () => n({ type: `ADD_CONDITION`, id: e.id }),
...
function ue({ question: e, index: t }) {
  let { dispatch: n } = T(),
    r = (t, r) => n({ type: `UPDATE_QUESTION`, id: e.id, patch: { [t]: r } });
  return (0, C.jsxs)(ae, {
    title: `Question ${t + 1}`,
    children: [
      (0, C.jsx)(se, {
      ...
      (0, C.jsx)(se, {
        ...
        value: e.subtitle,
        onChange: (e) => r(`subtitle`, e),
      }),
      (0, C.jsx)(le, { question: e }),
      (0, C.jsx)(ce, {
        label: `Enable Additional Comments`,
        checked: e.additionalComments,
        onChange: (e) => r(`additionalComments`, e),
      }),
      (0, C.jsx)(D, { question: e }),
      (0, C.jsx)(se, {
        label: `Button Text`,
        value: e.buttonText,
        onChange: (e) => r(`buttonText`, e),
      }),
    ],
  });
}
function de() {
  let { state: e, dispatch: t } = T(),
    n = e.content.thankYou,
    r = (e) => t({ type: `UPDATE_THANK_YOU`, patch: e });
  return (0, C.jsxs)(ae, {
        ...
        (0, C.jsxs)(`div`, {
          ...
          children: [
            (0, C.jsxs)(`label`, {
              ...
              children: [
                (0, C.jsx)(`span`, {
                  children: `Upload Media (PNG/JPG/JPEG/GIF)`,
                }),
                (0, C.jsx)(`input`, {
                  type: `file`,
                  ...
                  onChange: (e) => {
                    ...
                    (n.media?.startsWith(`blob:`) &&
                      URL.revokeObjectURL(n.media),
                      r({ media: i, mediaType: t.type }));
                  },
                }),
              ],
            }),
            ...
            (0, C.jsx)(E, {
              label: `Redirect Type`,
              value: n.redirectType,
              onChange: (e) => r({ redirectType: e }),
              options: [`URL`, `None`],
            }),
            n.redirectType === `URL` &&
              (0, C.jsx)(se, {
...
function fe() {
  ...
  return (0, C.jsxs)(`div`, {
    children: [
      (0, C.jsx)(oe, {}),
      e.content.questions.map((e, t) =>
        (0, C.jsx)(ue, { question: e, index: t }, e.id),
      ),
      (0, C.jsx)(de, {}),
    ],
  });
}
function O({ label: e, value: t, onChange: n }) {
  return (0, C.jsxs)(`label`, {
...
function k({
  ...
  return (0, C.jsxs)(`label`, {
    ...
    children: [
      (0, C.jsxs)(`span`, {
        children: [e, `: `, (0, C.jsx)(`b`, { children: t })],
      }),
      (0, C.jsx)(`input`, {
        type: `range`,
        value: t,
...
function A({ value: e = {}, onChange: t }) {
  return (0, C.jsx)(`div`, {
    ...
    children: [
      ...
      (0, C.jsx)(
        w,
        { label: r, value: e[n] || 0, onChange: (r) => t({ ...e, [n]: r }) },
        n,
      ),
    ),
  });
...
function pe() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.appearance,
    r = (e, n) =>
      t({ type: `UPDATE_STYLE`, path: `appearance.${e}`, value: n });
  return (0, C.jsxs)(ae, {
    title: `Appearance`,
    open: !0,
    children: [
      (0, C.jsx)(O, {
        ...
        onChange: (e) => r(`backgroundColor`, e),
      }),
      (0, C.jsx)(`small`, { children: `Individual Corner Radius` }),
      (0, C.jsx)(A, { value: n.radius, onChange: (e) => r(`radius`, e) }),
      (0, C.jsx)(w, {
        label: `Display Delay (seconds)`,
        value: n.displayDelay,
        min: 0,
        onChange: (e) => r(`displayDelay`, e),
      }),
      (0, C.jsx)(O, {
        label: `Backdrop Color`,
        value: n.backdropColor,
        onChange: (e) => r(`backdropColor`, e),
      }),
      (0, C.jsx)(k, {
        label: `Backdrop Opacity`,
        value: n.backdropOpacity,
        onChange: (e) => r(`backdropOpacity`, e),
      }),
    ],
  });
}
function me({ value: e = {}, onChange: t }) {
  return (0, C.jsx)(`div`, {
    className: `grid4`,
    children: [`top`, `right`, `bottom`, `left`].map((n) =>
      (0, C.jsx)(
        w,
        {
...
function he({ value: e, onChange: t, margin: n = !0 }) {
  let r = (n, r) => t({ ...e, [n]: r });
  return (0, C.jsxs)(`div`, {
    className: `control-stack`,
    children: [
      ...
      (0, C.jsxs)(`div`, {
        ...
        children: [
          (0, C.jsx)(E, {
            label: `Font Family`,
            value: e.fontFamily || `Inter`,
            onChange: (e) => r(`fontFamily`, e),
            options: [`Inter`, `Arial`, `Georgia`, `Verdana`],
          }),
          (0, C.jsx)(w, {
            label: `Font Size`,
            value: e.fontSize || 14,
            onChange: (e) => r(`fontSize`, e),
          }),
        ],
      }),
      (0, C.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, C.jsx)(E, {
            label: `Alignment`,
            value: e.alignment || `left`,
            onChange: (e) => r(`alignment`, e),
      ...
      (0, C.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, C.jsx)(ce, {
            label: `Italic`,
            checked: e.italic,
            onChange: (e) => r(`italic`, e),
          }),
          (0, C.jsx)(ce, {
            label: `Underline`,
            checked: e.underline,
            onChange: (e) => r(`underline`, e),
          }),
        ],
      }),
      n &&
        (0, C.jsxs)(C.Fragment, {
          children: [
            (0, C.jsx)(`small`, { children: `Margins` }),
            (0, C.jsx)(me, {
              value: e.margin,
              onChange: (e) => r(`margin`, e),
            }),
          ],
        }),
    ],
...
function ge() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.questionTitle;
  return (0, C.jsx)(ae, {
    title: `Question Title Styling`,
    children: (0, C.jsx)(he, {
      value: n,
      onChange: (e) =>
        t({ type: `UPDATE_STYLE`, path: `questionTitle`, value: e }),
    }),
  });
}
function _e() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.subtitle;
  return (0, C.jsx)(ae, {
    title: `Subtitle Styling`,
    children: (0, C.jsx)(he, {
      value: n,
      onChange: (e) => t({ type: `UPDATE_STYLE`, path: `subtitle`, value: e }),
    }),
  });
}
function ve() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.options,
    r = (e, n) => t({ type: `UPDATE_STYLE`, path: `options.${e}`, value: n });
  return (0, C.jsxs)(ae, {
    title: `Option List Styling`,
    children: [
      (0, C.jsx)(E, {
        label: `Layout`,
        value: n.layout,
        onChange: (e) => r(`layout`, e),
      ...
      (0, C.jsxs)(`div`, {
        ...
        children: [
          (0, C.jsx)(w, {
            label: `Option Height`,
            value: n.optionHeight,
            onChange: (e) => r(`optionHeight`, e),
          }),
          (0, C.jsx)(w, {
            label: `Bullet Spacing`,
            value: n.bulletSpacing,
            onChange: (e) => r(`bulletSpacing`, e),
          }),
          (0, C.jsx)(w, {
            label: `Option Spacing`,
            value: n.optionSpacing,
            onChange: (e) => r(`optionSpacing`, e),
          }),
          (0, C.jsx)(w, {
            label: `Corner Radius`,
            value: n.borderRadius,
            onChange: (e) => r(`borderRadius`, e),
          }),
        ],
      }),
    ],
...
function ye() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.options.selected,
    r = (e) => t({ type: `UPDATE_STYLE`, path: `options.selected`, value: e });
  return (0, C.jsxs)(ae, {
    title: `Selected Option Styling`,
    children: [
      (0, C.jsx)(O, {
        label: `Border Color`,
        value: n.borderColor,
        onChange: (e) => r({ ...n, borderColor: e }),
      }),
      (0, C.jsx)(O, {
        label: `Background Color`,
        value: n.backgroundColor,
        onChange: (e) => r({ ...n, backgroundColor: e }),
      }),
      (0, C.jsx)(w, {
        label: `Border Width`,
        value: n.borderWidth,
        onChange: (e) => r({ ...n, borderWidth: e }),
      }),
      (0, C.jsx)(he, { value: n, margin: !1, onChange: r }),
    ],
  });
}
function be() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.options.unselected,
    r = (e) =>
      t({ type: `UPDATE_STYLE`, path: `options.unselected`, value: e });
  return (0, C.jsxs)(ae, {
    title: `Unselected Option Styling`,
    children: [
      (0, C.jsx)(O, {
        label: `Border Color`,
        value: n.borderColor,
...
function xe() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.comments;
  return (0, C.jsx)(ae, {
    title: `Additional Comment Styling`,
    children: (0, C.jsx)(he, {
      value: n,
      onChange: (e) => t({ type: `UPDATE_STYLE`, path: `comments`, value: e }),
    }),
  });
}
function Se() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.ctaButton,
    r = (e, n) => t({ type: `UPDATE_STYLE`, path: `ctaButton.${e}`, value: n });
  return (0, C.jsxs)(ae, {
    ...
    children: [
      ...
      (0, C.jsxs)(`div`, {
        ...
        children: [
          (0, C.jsx)(O, {
            label: `Border`,
            value: n.borderColor,
            onChange: (e) => r(`borderColor`, e),
          }),
          (0, C.jsx)(O, {
            label: `Text`,
            value: n.textColor,
            onChange: (e) => r(`textColor`, e),
          }),
          (0, C.jsx)(O, {
            label: `Background`,
            value: n.backgroundColor,
      ...
      (0, C.jsx)(A, { value: n.radius, onChange: (e) => r(`radius`, e) }),
      (0, C.jsx)(`small`, { children: `Margins` }),
      (0, C.jsx)(me, { value: n.margin, onChange: (e) => r(`margin`, e) }),
    ],
  });
}
function Ce() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.crossButton,
    r = (e, n) =>
      t({ type: `UPDATE_STYLE`, path: `crossButton.${e}`, value: n });
  return (0, C.jsxs)(ae, {
      ...
      (0, C.jsxs)(`div`, {
        ...
        children: [
          (0, C.jsx)(O, {
            label: `Cross Color`,
            value: n.crossColor,
            onChange: (e) => r(`crossColor`, e),
          }),
          (0, C.jsx)(O, {
            label: `Fill Color`,
            value: n.fillColor,
            onChange: (e) => r(`fillColor`, e),
          }),
          (0, C.jsx)(O, {
            label: `Stroke Color`,
            value: n.strokeColor,
            onChange: (e) => r(`strokeColor`, e),
          }),
          (0, C.jsx)(w, {
            label: `Size`,
            value: n.size,
...
function we() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.thankYou,
    r = (e, n) => t({ type: `UPDATE_STYLE`, path: `thankYou.${e}`, value: n });
  return (0, C.jsxs)(ae, {
    title: `Thank You Page Styling`,
    children: [
      (0, C.jsx)(`b`, { children: `Title` }),
      (0, C.jsx)(he, { value: n.title, onChange: (e) => r(`title`, e) }),
      (0, C.jsx)(`b`, { children: `Subtitle` }),
      (0, C.jsx)(he, { value: n.subtitle, onChange: (e) => r(`subtitle`, e) }),
      (0, C.jsxs)(`div`, {
        className: `grid2`,
        children: [
          (0, C.jsx)(w, {
            label: `Image Width`,
            value: n.image.width,
            onChange: (e) => r(`image`, { ...n.image, width: e }),
          }),
          (0, C.jsx)(w, {
            label: `Image Height`,
            value: n.image.height,
            onChange: (e) => r(`image`, { ...n.image, height: e }),
          }),
        ],
      }),
      (0, C.jsx)(`b`, { children: `Button` }),
      (0, C.jsx)(ce, {
        label: `Full Width`,
        checked: n.button.fullWidth,
        onChange: (e) => r(`button`, { ...n.button, fullWidth: e }),
      }),
      (0, C.jsx)(O, {
        label: `Button Background`,
        value: n.button.backgroundColor,
        onChange: (e) => r(`button`, { ...n.button, backgroundColor: e }),
      }),
    ],
  });
}
...
var Ee = (e) => ({
    ...
    fontSize: e.fontSize,
    fontWeight: e.bold ? 700 : e.fontWeight,
    fontStyle: e.italic ? `italic` : `normal`,
    textDecoration: e.underline ? `underline` : `none`,
    textAlign: e.alignment,
    margin: `${e.margin?.top || 0}px ${e.margin?.right || 0}px ${e.margin?.bottom || 0}px ${e.margin?.left || 0}px`,
  }),
  De = (e) =>
    typeof e == `number`
      ? e + `px`
      : `${e?.tl || 0}px ${e?.tr || 0}px ${e?.br || 0}px ${e?.bl || 0}px`;
function Oe({ option: e, question: t }) {
  let { state: n, dispatch: r } = T(),
    i = n.styling.options,
    a = n.preview.selectedOptions[t.id] === e.id,
    o = a ? i.selected : i.unselected;
  return (0, C.jsxs)(`button`, {
    className: `preview-option ${a ? `selected` : ``} ${i.layout}`,
    style: {
      height: i.optionHeight,
      marginBottom: i.optionSpacing,
    ...
    onClick: () =>
      r({ type: `SELECT_OPTION`, questionId: t.id, optionId: e.id }),
    children: [
      (0, C.jsx)(`span`, {
        className: `bullet`,
        style: { marginRight: i.bulletSpacing },
        children: a ? `✓` : i.layout === `checkbox` ? `□` : `○`,
      }),
      e.text,
    ],
  });
}
function ke({ question: e }) {
  let { state: t, dispatch: n } = T(),
    r = t.styling.comments;
  return (0, C.jsx)(`textarea`, {
    placeholder: `Additional comments...`,
    value: t.preview.comments[e.id] || ``,
    onChange: (t) =>
      n({ type: `UPDATE_COMMENT`, questionId: e.id, value: t.target.value }),
    style: {
...
function Ae({ style: e, children: t, onClick: n }) {
  return (0, C.jsx)(`button`, {
    ...
    style: {
      ...
      borderRadius: De(e.radius),
    },
    children: t,
  });
}
function je({ question: e, index: t }) {
  let { state: n, dispatch: r } = T(),
    i = n.content.questions;
  return t >= i.length
    ? (0, C.jsxs)(`div`, {
        className: `complete`,
        children: [
          (0, C.jsx)(`h2`, { children: `Survey completed` }),
          (0, C.jsx)(`p`, { children: `Thank you for your response.` }),
        ],
      })
    : (0, C.jsxs)(C.Fragment, {
        children: [
          (0, C.jsxs)(`div`, {
            className: `progress`,
            children: [`Question `, t + 1, ` of `, i.length],
          }),
          (0, C.jsx)(`h2`, {
            style: Ee(n.styling.questionTitle),
            children: e.title,
          }),
          (0, C.jsx)(`p`, {
            style: Ee(n.styling.subtitle),
            children: e.subtitle,
          }),
          e.options.map((t) =>
            (0, C.jsx)(Oe, { option: t, question: e }, t.id),
          ),
          e.additionalComments && (0, C.jsx)(ke, { question: e }),
          (0, C.jsxs)(`div`, {
            className: `nav-row`,
            children: [
              t > 0 &&
                (0, C.jsx)(`button`, {
                  className: `back-btn`,
                  onClick: () =>
                    r({ type: `SET_CURRENT_QUESTION`, index: t - 1 }),
                  children: `Back`,
                }),
              (0, C.jsx)(Ae, {
                style: n.styling.ctaButton,
                onClick: () => {
                  let a = t + 1;
                  if (e.logic.enabled) {
                    let t = e.logic.conditions.find(
                      (t) => t.optionId === n.preview.selectedOptions[e.id],
                    );
                    t && (a = t.target - 1);
                  }
                  a < i.length
                    ? r({ type: `SET_CURRENT_QUESTION`, index: a })
                    : n.content.thankYou.enabled
                      ? r({ type: `SHOW_THANK_YOU` })
                      : r({ type: `SET_CURRENT_QUESTION`, index: i.length });
                },
...
function Me() {
  let { state: e } = T(),
    t = e.content.thankYou,
    n = e.styling.thankYou;
  return (0, C.jsxs)(`div`, {
    className: `thank-preview`,
    children: [
      t.media &&
        (0, C.jsx)(`img`, {
          src: t.media,
      ...
      (0, C.jsx)(`h2`, { style: Ee(n.title), children: t.title }),
      (0, C.jsx)(`p`, { style: Ee(n.subtitle), children: t.subtitle }),
      (0, C.jsx)(Ae, {
        style: n.button,
        onClick: () => {
          t.redirectType === `URL` &&
            /^https?:\/\/.+/i.test(t.redirectUrl) &&
...
function Ne() {
  let { state: e } = T(),
    t = e.preview;
  return t.isClosed
    ? (0, C.jsx)(`div`, { className: `closed`, children: `Survey Closed` })
    : t.showThankYou
      ? (0, C.jsx)(Me, {})
      : (0, C.jsx)(je, {
          question: e.content.questions[t.currentQuestion] || {},
          index: t.currentQuestion,
        });
}
function Pe() {
  let { state: e, dispatch: t } = T(),
    n = e.styling.appearance,
    r = e.styling.crossButton;
  return (0, C.jsx)(`div`, {
    className: `phone-wrap`,
    children: (0, C.jsxs)(`div`, {
      className: `phone`,
      children: [
        (0, C.jsx)(`div`, { className: `notch` }),
        (0, C.jsxs)(`div`, {
          className: `screen`,
          style: { background: n.backgroundColor, borderRadius: De(n.radius) },
          children: [
            r.enabled &&
              !e.preview.isClosed &&
              (0, C.jsx)(`button`, {
                className: `close ${r.style}`,
                onClick: () => t({ type: `CLOSE_SURVEY` }),
                style: {
                  width: r.size,
                  height: r.size,
                  color: r.crossColor,
                  background: r.fillColor,
                  borderColor: r.strokeColor,
                },
                children: `×`,
              }),
            (0, C.jsx)(Ne, {}),
      ...
      (0, C.jsxs)(`section`, {
        ...
        children: [
          (0, C.jsxs)(`div`, {
            ...
            children: [
              (0, C.jsx)(`button`, {
                className: e === `content` ? `active` : ``,
                onClick: () => t(`content`),
                children: `Content`,
              }),
              (0, C.jsx)(`button`, {
                className: e === `styling` ? `active` : ``,
                onClick: () => t(`styling`),
                children: `Styling`,
              }),
            ],
          }),
          e === `content` ? (0, C.jsx)(fe, {}) : (0, C.jsx)(Te, {}),
        ],
      }),
      (0, C.jsxs)(`aside`, {
        className: `preview-pane`,
        children: [
          (0, C.jsx)(`h3`, { children: `Live Mobile Preview` }),
          (0, C.jsx)(`p`, { children: `Changes update instantly` }),
          (0, C.jsx)(Pe, {}),
        ],
      }),
    ],
...
function Ie() {
  return (0, C.jsxs)(re, {
    children: [(0, C.jsx)(ie, {}), (0, C.jsx)(Fe, {})],
  });
}
(0, v.createRoot)(document.getElementById(`root`)).render(
  (0, C.jsx)(_.StrictMode, { children: (0, C.jsx)(Ie, {}) }),
);
